...
本项目由 **太原理工大学** 与 **西北师范大学团队学生** 合作完成，面向红色数字文化遗产保护、空间记忆还原和数字文旅传播展开探索。
...
地图、长城水彩背景、GLB 模型和历史文案来自本项目整理的演示素材。仓库中的合作院校 Logo 仅用于标识项目合作关系，来源于两校公开发布的校徽与字标资源。使用或再分发相关标志时，请遵循学校官方发布的品牌规范与使用要求。
